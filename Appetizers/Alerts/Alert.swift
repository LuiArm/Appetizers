...
struct AlertContext {
    ...
    static let invalidResponse = AlertItem(title: Text("Server Error"), message: Text("Invalide response from server. Please try again later."), dismissButton: .default(Text("OK")))
    ...
    static let userSaveSuccess = AlertItem(title: Text("Profile Saved"), message: Text("Your profile was successfuly saved."), dismissButton: .default(Text("OK")))
    
    static let invalidUserData = AlertItem(title: Text("Profile Error"), message: Text("There was an error saving or retrieving you profile."), dismissButton: .default(Text("OK")))
