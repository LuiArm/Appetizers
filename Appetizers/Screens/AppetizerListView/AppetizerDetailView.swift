        ...
        VStack{
            ...
            VStack{
                ...
                HStack(spacing: 40){
                    ...
                    NutrionInfo(title: "Calories", value: "\(appetizer.calories) cal")
            
                    NutrionInfo(title: "Carbs", value: "\(appetizer.carbs) g")
                    
                    NutrionInfo(title: "Protein", value: "\(appetizer.protein) g")
                }
            }
